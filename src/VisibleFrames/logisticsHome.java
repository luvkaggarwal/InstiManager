 ...
 * @author luv
 */
public class logisticsHome extends javax.swing.JFrame {

    /**
     * Creates new form logisticsHome
     */
    public logisticsHome() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(logisticsHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new logisticsHome().setVisible(true);
            }
        });
    }
