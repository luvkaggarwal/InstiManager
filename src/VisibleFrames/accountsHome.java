 ...
 * @author luv
 */
public class accountsHome extends javax.swing.JFrame {

    /**
     * Creates new form accountsHome
     */
    public accountsHome() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(accountsHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new accountsHome().setVisible(true);
            }
        });
    }
